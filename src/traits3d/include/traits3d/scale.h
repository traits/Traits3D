...
protected:
    ...
    virtual void setMajors(size_t val)
    {
        majorintervals_p = val;   //!< Sets number of major intervals
    }
    virtual void setMinors(size_t val)
    {
        minorintervals_p = val;   //!< Sets number of minor intervals per major interval
    }
    virtual void setMajorLimits(double start, double stop);

    size_t majors() const
    {
        return majorintervals_p;   //!< Returns number of major intervals
    }
    size_t minors() const
    {
        return minorintervals_p;   //!< Returns number of minor intervals per major interval
    }
