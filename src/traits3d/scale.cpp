...
//representation. The default return value is simply the tic values Traits3D::Label::String
//representation. Overwrite this function, if you plan to transform the value
//in some way. See e.g. Traits3D::LogScale::ticLabel.
//\param idx the current major tic index
//\return The Traits3D::Label::String representation for the value corresponding to a valid index,
//an empty Traits3D::Label::String else.
//*/
//Traits3D::Label::String Traits3D::Scale::ticLabel(unsigned int idx) const
//{
//  if (idx<majors_p.size())
//  {
//    return Traits3D::Label::number(majors_p[idx]);
//  }
