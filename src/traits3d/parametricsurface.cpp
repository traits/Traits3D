...
const TripleVector &ParametricSurface::data()
{
    if (dirty_data_p)
        if (updateData())
            dirty_data_p = false;
...
bool ParametricSurface::setDomain(double min_u, double max_u, double min_v, double max_v)
{
...
bool ParametricSurface::setHull(Box const &hull)
{
...
bool ParametricSurface::updateData()
{
