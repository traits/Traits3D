...
const float Protean3D::ExtGLWidget::eps_ = std::numeric_limits<float>::epsilon();

/*!
  This should be the first call in your derived classes constructors.
*/
Protean3D::ExtGLWidget::ExtGLWidget()
{
...
*/
bool Protean3D::ExtGLWidget::setRotation( float xVal, float yVal, float zVal )
{
...
*/
bool Protean3D::ExtGLWidget::setShift( float xVal, float yVal, float zVal )
{
...
/**
  ...
  \see setShift()
*/
bool Protean3D::ExtGLWidget::setViewportShift( float xVal, float yVal )
{
...
*/
bool Protean3D::ExtGLWidget::setScale( float xVal, float yVal, float zVal )
{
...
*/
bool Protean3D::ExtGLWidget::setZoom( float val )
{
  if (zoom_ == val)
    return false;
...
*/
bool Protean3D::ExtGLWidget::setOrtho( bool val )
{
  if (val == ortho_)
    return false;
...
*/
bool Protean3D::ExtGLWidget::initializeGL()
{
...
void Protean3D::ExtGLWidget::enableLighting(bool val)
{
...
void Protean3D::ExtGLWidget::disableLighting(bool val)
{
  enableLighting(!val);
}

bool Protean3D::ExtGLWidget::lightingEnabled() const
{
...
/**
  ...
  \see setLight
*/
void Protean3D::ExtGLWidget::illuminate(unsigned light)
{
  if (light>7)
    return;
...
/**
  ...
  \see setLight
*/
void Protean3D::ExtGLWidget::blowout(unsigned light)
{
  if (light>7)
    return;
  lights_[light].unlit = false;
...
*/
void Protean3D::ExtGLWidget::setMaterialComponent(GLenum property, float r, float g, float b, float a)
{
...
*/
void Protean3D::ExtGLWidget::setMaterialComponent(GLenum property, float intensity)
{
...
/**
  Sets GL shininess
*/
void Protean3D::ExtGLWidget::setShininess(float exponent)
{
  ////makeCurrent();
...
*/
void Protean3D::ExtGLWidget::setLightComponent(GLenum property, float r, float g, float b, float a, unsigned light)
{
  //GLfloat rgba[4] = {(GLfloat)r, (GLfloat)g, (GLfloat)b, (GLfloat)a};
  ////makeCurrent();
...
/**
  ...
  and a blending alpha with value 1.0
*/
void Protean3D::ExtGLWidget::setLightComponent(GLenum property, float intensity, unsigned light)
{
...
*/
void Protean3D::ExtGLWidget::setLightRotation( float xVal, float yVal, float zVal, unsigned light )
{
  if (light>7)
    return;
...
/**
  ...
  \see setViewportShift()
*/
void Protean3D::ExtGLWidget::setLightShift( float xVal, float yVal, float zVal, unsigned light )
{
  if (light>7)
    return;
...
void Protean3D::ExtGLWidget::applyLight(unsigned light)
{
...
void Protean3D::ExtGLWidget::applyLights()
{
...
//bool Protean3D::ExtGLWidget::init_glloader()
//{
//  // Initialize glloader
//
