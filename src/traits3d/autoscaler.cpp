...
Traits3D::LinearAutoScaler::LinearAutoScaler()
{
  init(0,1,1);
...
*/
Traits3D::LinearAutoScaler::LinearAutoScaler(std::vector<double>& mantisse)
{
  init(0,1,1);
  if (mantisse.empty())
  {
...
*/
void Traits3D::LinearAutoScaler::init(double start, double stop, size_t ivals)
{
  start_ = start;
  stop_ = stop;
...
\endverbatim
*/
double Traits3D::LinearAutoScaler::anchorvalue(double start, double m, int n)
{
...
\endverbatim
*/
int Traits3D::LinearAutoScaler::segments(int& l_intervals, int& r_intervals, double start, double stop, double anchor, double m, int n)
{
...
*/
size_t Traits3D::LinearAutoScaler::execute(double& a, double& b, double start, double stop, size_t ivals)
{
