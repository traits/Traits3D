...
*/
bool Function::setDomain(double min_x, double max_x, double min_y, double max_y)
{
...
\return false for pathological cases (min >= max), true else
*/
bool Function::setRange(double min_z, double max_z)
{
    if ((min_z >= max_z))
        return false;
...
MatrixF Function::dataF()
{
    MatrixD const &d = data();
    return d.convert<TripleF>();
}

bool Function::updateData()
{
