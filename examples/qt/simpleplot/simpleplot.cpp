...
class Broeckchen : public Function
{
public:
    Broeckchen()
    {
...
public:
    ...
    Rosenbrock()
    {
        setRotation(deg2rad(30), 0, deg2rad(15));
        setScale(1, 1, 1);
        setShift(0.15f, 0, 0);
        setZoom(0.9f);
    ...
    bool initializeGL()
    {
        ...
        setBackgroundColor(Color(0.95f));
        return loadData();
    }
    ...
    bool loadData()
    {
        ...
        setDataColor(ColorTable::stdColor(100));
        return setMeshColor(Color(0.0, 0.5, 0.5, 0));
    }
...
int main(int argc, char **argv)
{
    ...
    QtWidget <Rosenbrock> rosenbrock;
