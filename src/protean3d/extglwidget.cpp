...
*/
void ExtGLWidget::setLightRotation( float xVal, float yVal, float zVal, unsigned light )
{
	if (light>7)
    return; 
...
/**
  ...
  \param light light number
	\see setViewportShift()
*/
void ExtGLWidget::setLightShift( float xVal, float yVal, float zVal, unsigned light )
{
	if (light>7)
    return; 
