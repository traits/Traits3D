...
namespace
{
  Traits3D::Color Qt2GL(QColor col)
  {
    QRgb qrgb = col.rgb();
    Traits3D::Color rgba;
...
void MeshMainWindow::setGrid(Traits3D::SIDE s, bool b)
{
 ...
 int sum = widget_->plot3d->coordinates()->grids();
  ...
  widget_->plot3d->coordinates()->setGridLines(sum!=Traits3D::NOSIDEGRID, sum!=Traits3D::NOSIDEGRID, sum);
  widget_->update();
}
...
void MeshMainWindow::resetColors()
{
  ...
  const Traits3D::Color axc = Traits3D::Color(0,0,0,1);
  const Traits3D::Color bgc = Traits3D::Color(1.0,1.0,1.0,1.0);
  const Traits3D::Color msc = Traits3D::Color(0,0,0,1);
  const Traits3D::Color nuc = Traits3D::Color(0,0,0,1);
  const Traits3D::Color lbc = Traits3D::Color(0,0,0,1);
  const Traits3D::Color tc = Traits3D::Color(0,0,0,1);
  ...
  widget_->plot3d->setDataColor(Traits3D::ColorTable::stdColor(100));
  widget_->updateData();  
