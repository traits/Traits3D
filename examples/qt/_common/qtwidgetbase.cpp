...
*/
void QtWidgetBase::enableMouse(bool val) {mouse_input_enabled_ = val;}

/** 
\see enableMouse()
*/
void QtWidgetBase::disableMouse(bool val) {mouse_input_enabled_ = !val;}
bool QtWidgetBase::mouseEnabled() const {return mouse_input_enabled_;}
...
*/
void QtWidgetBase::enableKeyboard(bool val) {kbd_input_enabled_ = val;}

/** 
\see enableKeyboard()
*/
void QtWidgetBase::disableKeyboard(bool val) {kbd_input_enabled_ = !val;}
bool QtWidgetBase::keyboardEnabled() const {return kbd_input_enabled_;}
