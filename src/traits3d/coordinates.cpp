...
Traits3D::Coordinates::Coordinates(Traits3D::Triple first, Traits3D::Triple second, Traits3D::COORDINATESTYLE st)
{
...
Traits3D::Coordinates::~Coordinates()
{
}

void Traits3D::Coordinates::init(Traits3D::Triple first, Traits3D::Triple second)
{
...
void Traits3D::Coordinates::init(Traits3D::Box hull)
{
  init(hull.minVertex, hull.maxVertex);
}

bool Traits3D::Coordinates::initializeGL()
{
  for (auto& a : axes)
  {
    if (!a.initializeGL())
...
void Traits3D::Coordinates::autoDecorateExposedAxis(Axis& ax, Triple const& projected_ax, bool left)
{
...
void Traits3D::Coordinates::setPosition(Triple first, Triple second)
{
  first_ = first;
  second_ = second;
}
...
void Traits3D::Coordinates::setStyle(Traits3D::COORDINATESTYLE s, Traits3D::AXIS frame_1,
                           Traits3D::AXIS frame_2, Traits3D::AXIS frame_3)
{
  style_ = s;
...
*/
void Traits3D::Coordinates::setGridLines(bool majors, bool minors, int sides)
{
  sides_ = sides;
...
void Traits3D::Coordinates::detach(size_t idx)
{
