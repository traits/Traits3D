...
namespace Traits3D
{
  ...
  public:
    ...
    TripleF const& position() const { return pos_; }
    void setPosition(TripleF const& pos) { pos_ = pos; }
    ...
    void setAmbientIntensity(float val) { ambient_intensity_ = val; }

    // [0,1]
    float specularIntensity() const { return specular_intensity_; }
    void setSpecularIntensity(float val) { specular_intensity_ = val; }
