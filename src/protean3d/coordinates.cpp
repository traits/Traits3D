...
Protean3D::Coordinates::Coordinates(Protean3D::Triple first, Protean3D::Triple second, Protean3D::COORDINATESTYLE st)
{
...
Protean3D::Coordinates::~Coordinates()
{
}

void Protean3D::Coordinates::init(Protean3D::Triple first, Protean3D::Triple second)
{
...
void Protean3D::Coordinates::draw(glm::mat4 const& proj_matrix, glm::mat4 const& mv_matrix)
{
...
void Protean3D::Coordinates::chooseAxes(
...
void Protean3D::Coordinates::autoDecorateExposedAxis(Axis& ax, Triple const& projected_ax, bool left)
{
...
void Protean3D::Coordinates::setPosition(Triple first, Triple second)
{
  first_ = first;
  second_ = second;
}

void Protean3D::Coordinates::setAutoScale(bool val)
{
  for (unsigned i=0; i!=axes.size(); ++i)
    axes[i].setAutoScale(val);
}

void Protean3D::Coordinates::recalculateAxesTics()
{
  for (unsigned i=0; i!=axes.size(); ++i)
    axes[i].recalculateTics();
}

void Protean3D::Coordinates::setStandardScale()
{
  for (unsigned i=0; i!=axes.size(); ++i)
    axes[i].setScale(LINEARSCALE);
}

void Protean3D::Coordinates::setStyle(Protean3D::COORDINATESTYLE s, Protean3D::AXIS frame_1,
...
*/
void Protean3D::Coordinates::setGridLines(bool majors, bool minors, int sides)
{
  sides_ = sides;
...
void Protean3D::Coordinates::drawMajorGridLines()
{
...
void Protean3D::Coordinates::drawMinorGridLines()
{
  //glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
  //glColor4d(gridlinecolor_.r,gridlinecolor_.g,gridlinecolor_.b,gridlinecolor_.a);
...
void Protean3D::Coordinates::drawMajorGridLines(Axis& a0, Axis& a1)
{
...
void Protean3D::Coordinates::drawMinorGridLines(Axis& a0, Axis& a1)
{
// Triple d = a1.begin()-a0.begin();
...
void Protean3D::Coordinates::attach(size_t idx)
{
  if (aidx_.end() == std::find(aidx_.begin(), aidx_.end(), idx))
    aidx_.push_back(idx);
}

void Protean3D::Coordinates::detach(size_t idx)
{
